...
const CompetitionRemoveForm = (props: IProps) => {
    ...
    return (
        <form className="form-signin w-100 m-auto">
            ...
            <b>Do you realy want to remove this competition?</b>
            </label>
            <button
                onClick={(e) => props.onSubmit(e)}
                id="registerSubmit" className="w-100 btn btn-lg btn-primary">Delete competition</button>

        </form>
    );
}

export default CompetitionRemoveForm;
