...
const MessageAdd = () => {
    ...
    const onSubmit = async (event: MouseEvent) => {
        ...
        var jwtData = await messageService.postMessage(jwtResponse!, values);
    ...
    return (
        <MessageAddForm values={values} handleChange={handleChange} onSubmit={onSubmit} validationErrors={validationErrors} />
    );
}
